...
Gpio_t AntSwitchLf;  // Antenna switch GPIO pins objects
Gpio_t AntSwitchHf;
...
static uint8_t RxBuffer[RX_BUFFER_SIZE]; //Reception buffer
...
void SX1276_Init( void )
{
		...
		__GPIOB_CLK_ENABLE();
		GPIO_InitStruct.Pin = (GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_10);//DIO0-PB10, DIO1-PB2, DIO2-PB1, DIO3-PB0, 
		GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
		GPIO_InitStruct.Pull = GPIO_PULLUP;
		GPIO_InitStruct.Speed = GPIO_SPEED_FAST;
		HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

		GPIO_InitStruct.Pin = GPIO_PIN_11;    //NRESET-PB11
		GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

		__GPIOA_CLK_ENABLE();
		GPIO_InitStruct.Pin = (GPIO_PIN_2);//sx1279 board use active crystal, and PA2 control it's power supply
		GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
		GPIO_InitStruct.Pull = GPIO_PULLUP;
		GPIO_InitStruct.Speed = GPIO_SPEED_FAST;
    ...
    //SX1276SetOpMode( RF_OPMODE_SLEEP );   //20160317
		GPIO_InitTypeDef   GPIO_InitStructure;//DIO0 -- PB10, DIO1 -- PB2, DIO2 -- PB1, DIO3 -- PB0,
...
//SX1276SetRx( uint32_t timeout )
    ...
    memset1( RxBuffer, 0, ( size_t )RX_BUFFER_SIZE );
    ...
    switch( SX1276_State )
    {
        case RF_RX_RUNNING:// RxDone interrupt
            //TimerEvent_Stop( &RxTimeoutTimer );	
						...
						SPI_Read( 0, RxBuffer, SX1276_Payload_Size );   //SX1276ReadFifo( RxBuffer, SX1276_Payload_Size );
						...
						TimerEvent_Stop( &RxTimeoutTimer );
						OnRadioRxDone( RxBuffer, SX1276_Payload_Size, SX1276_Payload_RssiValue, SX1276_Payload_SnrValue );            
